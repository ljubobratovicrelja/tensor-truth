...
class ProviderModelConfig:
    """Static model entry for an openai_compatible provider."""

    name: str  # e.g. "meta-llama/Llama-3.1-70B"
    display_name: Optional[str] = None  # e.g. "Llama 3.1 70B"
    capabilities: List[str] = field(default_factory=list)  # ["tools", "thinking"]

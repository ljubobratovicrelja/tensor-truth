...
CUSTOM_CONTEXT_PROMPT_NO_SOURCES = (
    ...
    "The documents section contains a [WARNING] message. This means NO relevant documents "
    "were found in the indexed knowledge base. You MUST start your response "
    "with one of these exact phrases:\n"

...
class TestConfigMigration:
    ...
    def test_preserves_existing_providers(self):
        ...
        data = {
            "providers": [
                {"id": "ollama", "type": "ollama", "base_url": "http://localhost:11434"},
                {"id": "vllm", "type": "openai_compatible", "base_url": "http://localhost:8000/v1"},
            ],
        }
        migrated = TensorTruthConfig._migrate_config_data(data)
        ...
        data = {
            "providers": [
                {"id": "ollama", "type": "ollama", "base_url": "http://localhost:11434"},
                {
                    ...
                    "api_key": "test",
                    "models": [
                        {"name": "llama-70b", "capabilities": ["tools"], "context_window": 131072},
                    ],
                },
            ],
        }
